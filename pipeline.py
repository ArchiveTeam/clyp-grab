...
LUA_SHA1 = get_hash(os.path.join(CWD, 'clyp.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'clip':
                wget_args.extend(['--warc-header', 'clyp-clip: '+item_value])
                wget_args.append('https://clyp.it/'+item_value)
            elif item_type == 'user':
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/3/3b/Clyp-icon.png" height="50px" title=""/>
        <h2>clyp <span class="links"><a href="https://clyp.it/">Website</a> &middot; <a href="http://tracker.archiveteam.org/clyp/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Clyp">Wiki</a></span></h2>
        <p>Archiving Clyp.</p>
    '''
)
